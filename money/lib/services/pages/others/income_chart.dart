...
import 'package:money/services/pages/others/inforStat.dart';
import 'package:money/services/pages/reusable/pie_chart.dart';
...
class IncomeChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TransactionCategoryManager.incomeCategories.length == 0
        ? Center(
            child: Text(
              'No category found!',
              style: TextStyle(
